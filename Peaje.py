    ...
    class DataBase:
        ...
        def seleccionar(self):#inseercion de datos
            ...
            try:
                ...
                print("Fechas de los tickets:",ticketfecha)
                print("Subtotal de los tickets: ",ticketsub)
...
def rotar():
    ...
    lblTicketResult.configure(text="")
    lblOwnerResult.configure(text="")
    lblUbicationResult.configure(text="")

    lblReportResult.delete(0,END)
    lstTicketResult.delete(0,END)
...
btnTicket=tk.Button(marcoCentral,image=imgTicket,text=" Ver Tickets ", command=vertickets, font=textobotones,compound="left").place(relx=0.51, rely=0.49)
...
frameTicket = Frame()
frameTicket.place(relx=0.51, rely=0.55,relheight=0.30, relwidth=0.47)
frameTicket.config(bg="#CFCFCF")

lblTicket= Label(frameTicket,text="Total a Pagar por tickets pendientes de pago: ",font=textoEnunciado, bg="#CFCFCF").place(relx=0.01, rely=0.03)
lblTicketResult= Label(frameTicket,text="",font=textoResultado, bg="#CFCFCF")
lblTicketResult.place(relx=0.55, rely=0.03)

lstTicketResult= Listbox(frameTicket,font=textoResultado, bg="#CFCFCF", width=70, height=8)
lstTicketResult.place(relx=0.01, rely=0.17)
